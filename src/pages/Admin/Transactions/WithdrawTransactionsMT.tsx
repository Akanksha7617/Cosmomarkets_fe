...
export default () => {
      ...
      if (msg.status === 'ok') {
        ...
        if (msg.message.includes('User is disabled by admin')) {
          message.error({
            ...
            icon: <span className="red-error-icon"> ✘ </span>, // Custom icon for error
            className: 'red-error-notification', // Custom class for error styling
  ...
  async function exportExcel() {
    ...
    message.success({
      ...
      icon: <span className="green-success-icon"> ✔ </span>,  // Custom icon for success
      className: 'green-success-notification',  // Custom class for success styling
      duration: 3,  // Duration in seconds
    });
  ...
  return (
    <div>
      ...
      <div className="my-data-table" style={{ flex: 1, overflowY: 'auto' }}>
        <h2>WITHDRAW TRANSACTION MT5</h2>
