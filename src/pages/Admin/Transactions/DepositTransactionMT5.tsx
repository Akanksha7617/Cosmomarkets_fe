...
export default () => {
      ...
      if (msg.status === 'ok') {
        ...
        if (msg.message.includes('User is disabled by admin')) {
          message.error({
            ...
            icon: <span className="orange-error-icon"> ✘ </span>,  // Custom Icon
            className: 'orange-error-notification',  // Custom Class for styling
  ...
  //                                                 amount: amount
  //                                             })
  //                                             .then(() => fetchData(pagination.current, pagination.pageSize, "", record.type));
  //                                     }}
  //                                 >
  //                                     <Button><LikeTwoTone twoToneColor={token.colorSuccess} /></Button>
  //                                 </TextPopconfirm>
  //                             </Menu.Item>
  ...
  async function exportExcel() {
    ...
    let response = await rawApi.get(`/api/app/transaction/export/xlsx`, {
      responseType: 'blob',
    });
    ...
    message.success({
      content: 'File is downloading, please wait...',
      icon: <span className="green-success-icon"> ✔ </span>,  // Custom icon
      className: 'green-success-notification',  // Custom class for styling
